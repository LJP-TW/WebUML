...
export default function AttributeBlock(props) {
    ...
    if (props.attr.UMLtype === 'rectangle' ||
        ...
        return (
            <React.Fragment>
                ...
                <label>
                    Background color:
                    <input type="color" value={props.attr.fillcolor} onChange={handleFillcolorChange} />
                </label>
                <label>
                    Stroke color:
                ...
                <label>
                    Opacity:
                    <input type="number" value={props.attr.opacity} onChange={handleOpacityChange} onBlur={handleOpacityBlur} />
                </label>
            </React.Fragment>
        );
    }
